...
<div class="row">
	...
	<div class="col-sm-6 col-md-8">
		...
		<small><cite title="San Francisco, USA"><?php echo $Info['direccion_fiscal']; ?><i class="glyphicon glyphicon-map-marker"> </i></cite></small>
		<p>
			<?php if (!empty($Info['telefono'])) { ?>
				<i class="glyphicon glyphicon-phone"></i><?php  echo $Info['telefono']; ?><br />				
			<?php } ?>
			<?php if (!empty($Info['telefono2'])) { ?>
				<i class="glyphicon glyphicon-phone-alt"></i><?php  echo $Info['telefono2']; ?><br />				
			<?php } ?>
