...
<div class="grid_8">
	...
	<a href="#" id="planilla-<?php echo $id; ?>" class="editable" data-type="text" data-pk="iva_declaracion-planilla-<?php echo $id; ?>">
		<?php echo $Planilla['planilla'] . "</a></span> (" . $Planilla['mes'] ."/". $Planilla['anio']  ; ?>)
	<small>	<br>
	creada: 
		
		<a href="#" id="fecha_creacion-<?php echo $id; ?>" class="editable" data-type="text" data-pk="iva_declaracion-fecha_creacion-<?php echo $id; ?>">
		 	<?php echo $Planilla['fecha_creacion']; ?> 
		</a>
		presentada: 
		<a href="#" id="fecha_entrega-<?php echo $id; ?>" class="editable" data-type="text" data-pk="iva_declaracion-fecha_entrega-<?php echo $id; ?>">
		 	<?php echo $Planilla['fecha_entrega']; ?> 
		</a>
		elaborada: 
		<a href="#" id="elaborador-<?php echo $id; ?>" class="editable label label-warning" data-type="text" data-pk="iva_declaracion-elaborador-<?php echo $id; ?>">
		 	<?php echo $Planilla['elaborador']; ?> 
		</a></small></h4>
</div>
	        ...
	        <tbody>
	        	<tr><td>Total Débito Fiscal</td>
	        		<td class="text-right">Bs. 
	        			<a href="#" id="total_debitos-<?php echo $id; ?>" class="editable" data-type="text" data-pk="iva_declaracion-total_debitos-<?php echo $id; ?>">
	        				<?php echo dineroFormat($Planilla['total_debitos'], 2,'nobs'); ?>
	        			</a>
	        		</td>
			   		<td class="text-right">Bs. 
			   			<a href="#" id="total_iva_debitos-<?php echo $id; ?>" class="editable" data-type="text" data-pk="iva_declaracion-total_iva_debitos-<?php echo $id; ?>">
			   	...
			   	<tr><td>Total Crédito Fiscal</td>
	        		<td class="text-right">Bs. 
	        			<a href="#" id="total_creditos-<?php echo $id; ?>" class="editable" data-type="text" data-pk="iva_declaracion-total_creditos-<?php echo $id; ?>">
	        				<?php echo dineroFormat($Planilla['total_creditos'], 2,'nobs'); ?>
	        			</a>
	        		</td>
			   		<td class="text-right">Bs. 
			   			<a href="#" id="total_iva_creditos-<?php echo $id; ?>" class="editable" data-type="text" data-pk="iva_declaracion-total_iva_creditos-<?php echo $id; ?>">
			   	...
			   	<tr>
	        		<td colspan="3" class="text-right">Excedente Mes anterior &nbsp;&nbsp;&nbsp;
	        			<?php echo dineroFormat($Planilla['excedente_previo']); ?>
				...
				<tr>
					...
					?> &nbsp;&nbsp;&nbsp; Bs.  
					<a href="#" id="total_pagar-<?php echo $id; ?>" class="editable" data-type="text" data-pk="iva_declaracion-total_pagar-<?php echo $id; ?>">
