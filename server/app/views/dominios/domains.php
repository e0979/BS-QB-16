...
<?php 
                    	foreach ($this->dominios as $Dominio) {
								...
								$status_renovacion = 'domains-form';
								...
								if ($this->fields_group[$id_domain][$anio]['renewal'] === 'no') {
									 $status_renovacion = "toforgot-domains";
									 $status_pago = '';
								}
						  ...
						  <tr>
                        	...
                        	<th>
	                        	...
	                        	<form class="form <?php echo $status_renovacion; ?> ">
	                        		<div class="hide">
	                        		<?php 
					             ...
					             <div class="left">
									...
									<?php if ($this->fields_group[$id_domain][$anio]['payment_dominio'] === '') echo $status_pago; ?>
